<?php
/* 
 * Plugin developed by TurtleSoft for LEET.
 * Suggestions are not accepted because of school
 */
namespace TurtleSoft\TurtleSoft;
...
class BadWordBlocker extends PluginBase implements Listener {
    public function onEnable() {
        ...
        $this->getServer()->getLogger()->info("§3[LEET-Block] §aEnabled successfully");
    }
